...
\subtitle{05. Astrophysics of Black Holes} %% title page.
...
\begin{frame}{A First Model of Stellar Structure}
    ...
    \onslide<2-> Hydrostatic equilibrium\\
    $$\frac{dP(r)}{dr} = -\frac{GM(r)\rho(r)}{r^2}$$
    \onslide<3-> P: Pressure
...
\begin{frame}{A First Model of Stellar Structure}
    ...
    \onslide<2-> The total energy of the Sun will be released in just $10^7$ years.\\
\end{frame}

\begin{frame}{A Better Model of Stellar Structure}
	\onslide<1-> A. S. Eddington (1926):\\
    \onslide<2-> 1. The source of energy is thermonuclear.\\
    \onslide<2-> 2. Outward pressure of radiation should be included in the equations.
\end{frame}
